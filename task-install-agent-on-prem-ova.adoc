...
---
= Implementa un agente de consola en las instalaciones usando VCenter
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
NetApp admite la instalación del agente de la Console en tu entorno VCenter. El archivo OVA incluye una imagen de VM preconfigurada que puedes implementar en tu entorno VMware. Hay una descarga de archivo o una implementación por URL disponible directamente desde la NetApp Console. Incluye el software del agente de la Console y un certificado autofirmado.
