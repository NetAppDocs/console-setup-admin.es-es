...
|===
|===
Puntos finales contactados desde la consola de NetApp:: A medida que usas la aplicación basada en web NetApp Console SaaS, esta contacta varios endpoints para completar tareas de gestión de datos. Esto incluye endpoints a los que se conecta para desplegar el agente de la Console desde la Console.
+
--
...
. En la página *Detalles*, ingrese un nombre para el agente, especifique las etiquetas y elija si desea que la Consola cree un nuevo rol que tenga los permisos necesarios o si desea seleccionar un rol existente que configuró conlink:reference-permissions-azure.html["los permisos requeridos"] .
+
