...
+
https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/task-manage-capacity-settings.html["Obtenga más información sobre el modo de gestión de capacidad"^]
