...
.Pasos
. Selecciona *Administración > Soporte*.
...
+
Si usas esta opción, se te pedirá que vuelvas a iniciar sesión. Ten en cuenta que el token de estas cuentas caduca después de 90 días. Se publicará una notificación para avisarte de esto.
