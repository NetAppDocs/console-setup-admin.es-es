...
---
= Permisos de Azure para el agente NetApp Console
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
.3+| Usa Virtual Machine Scale Sets en el modo de orquestación flexible para especificar zonas concretas para Cloud Volumes ONTAP | Microsoft.Compute/virtualMachineScaleSets/write | Sí | No | No 
