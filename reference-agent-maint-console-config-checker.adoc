...
`--validationTypes <comma-separated list validation types to run>` --*REQUIRED*-- Elige uno o más tipos de validación para ejecutar. Los tipos de validación válidos son:
