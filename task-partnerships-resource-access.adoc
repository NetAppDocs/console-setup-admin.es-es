...
Puedes asignar los siguientes roles a los usuarios asociados:
...
* link:reference-iam-predefined-roles.html["Visor de clasificación de datos"]
...
* link:reference-iam-ransomware-roles.html["Administrador de resiliencia frente al ransomware"]
* link:reference-iam-ransomware-roles.html["Visor de resiliencia contra ransomware"]
* link:reference-iam-ransomware-roles.html#user-behavior-roles["Comportamiento del usuario de Resiliencia ante Ransomware"]
* link:reference-iam-ransomware-roles.html#user-behavior-roles["Visor del comportamiento del usuario de Ransomware Resilience"]
