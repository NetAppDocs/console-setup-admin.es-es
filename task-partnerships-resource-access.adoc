...
---
= Proporciona acceso a los recursos a los usuarios asociados en NetApp Console
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
Puedes asignar las siguientes funciones a los usuarios asociados:
...
. Selecciona el menú de acciones image:icon-action.png["un icono con tres puntos verticales"] junto a la asociación establecida que quieres ver y selecciona *Ver detalles*.
+
