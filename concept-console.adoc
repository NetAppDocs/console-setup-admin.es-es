...
summary: NetApp Console ofrece una experiencia SaaS para acceso completo a las funciones o una opción autohospedada para organizaciones con restricciones de conectividad. 
---
...
[role="lead"]
NetApp Console ofrece una experiencia SaaS para acceso completo a las funciones o una opción autohospedada para organizaciones con restricciones de conectividad.

Puede utilizar NetApp Console de dos maneras: como una experiencia SaaS totalmente administrada o como una solución autohospedada en su propio entorno de nube. Con la opción SaaS, accede a la consola a través de console.netapp.com mientras NetApp administra toda la infraestructura, la autenticación y las actualizaciones. Obtendrás acceso completo a las funciones directamente desde tu navegador web. Si elige la opción autohospedada, instalará un agente de consola en su entorno de AWS, Azure o Google Cloud. La interfaz se ejecuta localmente y el agente mantiene una conectividad saliente limitada a NetApp para tareas esenciales como autenticación y actualizaciones.

Elija la experiencia SaaS si su organización tiene conectividad a Internet estándar. Se beneficia de la configuración más sencilla, actualizaciones automáticas y acceso completo a todos los sistemas de almacenamiento, servicios de datos y funciones avanzadas de NetApp . Puede agregar agentes directamente desde la consola y NetApp se encarga de todo el mantenimiento.

Seleccione la opción autohospedada si su organización requiere controles estrictos de conectividad, seguridad o cumplimiento, como en el gobierno o en industrias reguladas. Obtendrás más control y aislamiento de la red, pero solo podrás administrar sistemas de almacenamiento NetApp seleccionados y utilizar servicios de datos limitados, con algunas funciones no disponibles. Instala un agente de consola manualmente y accede a la consola directamente desde la interfaz del agente local. Instale su agente a través de su mercado en la nube o mediante una instalación manual, y el agente se comunicará únicamente de manera saliente con NetApp, lo que garantiza que no haya conexiones entrantes a Internet.
...
image:diagram-standard-mode.png["Una imagen conceptual que muestra la arquitectura del modo estándar con Internet público donde están disponibles la capa SaaS y la autenticación auth0."]
...
image:diagram-restricted-mode.png["Una imagen conceptual del modo restringido."]
