...
---
= Despliega el agente de NetApp Console en modo privado
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
+
** Selecciona la versión que admite el modo privado. Consulta el link:whats-new.html["notas de la versión"] para la última versión compatible.
** Descarga el instalador offline para redes sin acceso a internet.
...
--
Proporciónale al agente de la NetApp Console las credenciales de la entidad de seguridad del servicio Azure que configuraste anteriormente.
