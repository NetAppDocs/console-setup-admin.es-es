...
+
Agregue nuevas credenciales de AWS a la consola para crear y administrar FSx para ONTAP. https://docs.netapp.com/us-en/bluexp-fsx-ontap/requirements/task-setting-up-permissions-fsx.html["Aprenda a configurar permisos para FSx para ONTAP"^]
...
+
*** https://docs.netapp.com/us-en/bluexp-fsx-ontap/requirements/task-setting-up-permissions-fsx.html["Ver los permisos necesarios para FSx para ONTAP"^]
*** link:task-install-connector-aws-bluexp.html#aws-permissions-agent["Ver la política de implementación del agente"]
...
Para obtener más detalles, consulte la https://docs.netapp.com/us-en/bluexp-fsx-ontap/requirements/task-setting-up-permissions-fsx.html["La documentación de la consola para Amazon FSx para ONTAP"^]
...
.Antes de empezar
Debe crear un agente de consola antes de poder configurar una suscripción. link:concept-connectors.html#connector-installation["Aprenda a crear un agente de consola"] .
