...
Necesita los permisos de *Administrador de la organización* o *Superadministrador* para administrar la identidad y el acceso de su organización. Con permisos de *Administrador de carpeta o proyecto*, puedes administrar solo las carpetas y los proyectos a los que tienes acceso.
