...
Necesitas permisos *Org admin* o *Super admin* para gestionar la identidad y el acceso de tu organización. Con permisos *Folder or project admin*, puedes gestionar solo las carpetas y proyectos a los que tienes acceso.
...
[role="quick-margin-para"]
Una vez que los usuarios se registren en NetApp Console, deberá agregarlos explícitamente a su organización de consola. También tiene la opción de agregar cuentas de servicio a su organización.
...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-5.png["Cinco"] Verifica tu organización (opcional)
[role="quick-margin-para"]
Si tu equipo utiliza la verificación de organización, vincula tu organización Console con la identidad de cuenta de empresa de NetApp.

[role="quick-margin-para"]
link:task-verify-organization.html["Aprende cómo verificar tu organización"].
...
* link:concept-verified-organization.html["Conoce las organizaciones verificadas en NetApp Console"]
