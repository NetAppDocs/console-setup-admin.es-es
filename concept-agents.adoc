...
Si no necesitas servicios avanzados de orquestación o protección de datos, puedes gestionar de forma centralizada los clústeres ONTAP locales y los servicios de almacenamiento nativos de cloud sin desplegar un agente. Algunas herramientas de supervisión y movilidad de datos también están disponibles sin un agente.
