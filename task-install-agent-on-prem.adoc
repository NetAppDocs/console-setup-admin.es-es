...
+
Elige descargar los archivos del instalador del agente o copiar una URL a los archivos.
...
NOTE: Si quieres configurar un proxy transparente, puedes hacerlo después de instalar un agente. link:reference-agent-maint-console-proxy.html["Obtenga información sobre la consola de mantenimiento del agente."].
