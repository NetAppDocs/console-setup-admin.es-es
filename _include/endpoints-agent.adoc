...
|===
a| https://bluexpinfraprod.eastus2.data.azurecr.io https://bluexpinfraprod.azurecr.io https://occmclientinfragov.azurecr.us (necesario para despliegues en modo restringido) a| Para obtener imágenes para actualizaciones de agentes de NetApp Console.

a| https://occmclientinfragov.azurecr.us a| Para obtener imágenes para actualizaciones de agentes de NetApp Console.
...
* \https://occmclientinfragov.azurecr.us.io (si estás en un entorno de modo restringido)
