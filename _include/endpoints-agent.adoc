...
a| https://occmclientinfragov.azurecr.us.io https://bluexpinfraprod.azurecr.io a| Para obtener imágenes para las actualizaciones de los agentes de la Consola.
