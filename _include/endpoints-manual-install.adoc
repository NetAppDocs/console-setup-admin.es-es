...
* Los puntos finales enumerados en la opción 1 son compatibles a partir de la versión 3.9.47 del agente de Console. No existe compatibilidad con versiones anteriores del agente de Console.
