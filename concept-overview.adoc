...
summary: La consola unifica la gestión y protección del almacenamiento en nubes híbridas múltiples con servicios de datos integrados para proteger y optimizar los datos. 
---
...
NetApp continúa ofreciendo BlueXP para sitios que no desean conectividad saliente. BlueXP se puede instalar en su red sin conectividad saliente. link:task-quick-start-private-mode.html["Obtenga información sobre BlueXP (modo privado) para sitios sin conectividad a Internet."]
