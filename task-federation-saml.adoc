...
---
= Federa NetApp Console con un proveedor de identidad SAML
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Fedérese con su proveedor de IdP SAML 2.0 para habilitar el inicio de sesión único (SSO) para la NetApp Console.  Esto permite a los usuarios iniciar sesión utilizando sus credenciales corporativas.
