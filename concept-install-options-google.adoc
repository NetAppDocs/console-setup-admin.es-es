...
* link:task-install-connector-google-bluexp-gcloud.html["Cree el agente de la consola directamente desde la consola"](esta es la opción estándar)
+
Esta acción inicia una instancia de VM que ejecuta Linux y el software del agente de consola en una VPC de su elección.

* link:task-install-connector-google-bluexp-gcloud.html["Crear el agente de consola mediante Google Platform"]
+
