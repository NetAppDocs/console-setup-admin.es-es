...
== Verifica el acceso a la red y a los puertos para el agente de la Console
...
Ejecuta comprobaciones de configuración en los agentes de Console desde la Console o la consola de mantenimiento del Agent para asegurarte de que pueden acceder a los endpoints requeridos y que los puertos necesarios están abiertos.

También puede ejecutar comprobaciones de configuración mediante la consola de mantenimiento del agente.link:reference-agent-maint-console-config-checker.html["Obtenga más información sobre el uso del comando validate de config-checker."]
