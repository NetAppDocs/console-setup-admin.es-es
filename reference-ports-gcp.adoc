...
summary: Las reglas del firewall de Google Cloud para el agente requieren tanto reglas de entrada como de salida. La NetApp Console crea automáticamente este grupo de seguridad cuando creas un agente de la Console desde la Console. Para otras opciones de instalación, necesitas configurar este grupo de seguridad manualmente. 
---
= NetApp Reglas de firewall del agente de NetApp Console en Google Cloud
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Las reglas del firewall de Google Cloud para el agente requieren tanto reglas de entrada como de salida. La NetApp Console crea automáticamente este grupo de seguridad cuando creas un agente de la Console desde la Console. Para otras opciones de instalación, necesitas configurar este grupo de seguridad manualmente.
...
| DNS | UDP | 53 | DNS | Utilizado para la resolución de DNS por Data Classification 
|===