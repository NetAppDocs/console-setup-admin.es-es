...
---
= Asociar las credenciales del agente de Console con su suscripción a Google Cloud
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Cuando crea un agente de consola en Google Cloud, puede usar las credenciales asociadas para suscribirse a NetApp Intelligent Services, que incluyen Cloud Volumes ONTAP y los servicios de datos de NetApp .  Debes asociar la suscripción con el agente cuyas credenciales deseas utilizar para pagar los servicios.
...
Reemplazar la suscripción actual del mercado por una nueva actualiza la suscripción para los sistemas Cloud Volumes ONTAP existentes y nuevos.
...
La suscripción a los servicios de datos de NetApp a través de Google Cloud Marketplace puede fallar debido a permisos incorrectos o redirección faltante a la consola. Si esto sucede, siga los siguientes pasos para completar el proceso de suscripción.
