...
Asigna a uno o más usuarios, tanto de la organización iniciadora como de la receptora, el rol de Partnership admin para crear y gestionar asociaciones. Puedes asignar el rol de Partnership viewer a usuarios que solo necesiten ver asociaciones, no gestionarlas.
