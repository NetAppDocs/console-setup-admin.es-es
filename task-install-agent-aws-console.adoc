...
. En la página *Red*, especifique una VPC, una subred y un par de claves para el agente, elija si desea habilitar una dirección IP pública y, opcionalmente, especifique una configuración de proxy.
+
