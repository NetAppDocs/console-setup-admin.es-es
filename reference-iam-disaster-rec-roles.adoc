...
* *Administrador de recuperación ante desastres*: Realice cualquier acción.
* *Administrador de recuperación ante desastres*: Realizar la conmutación por error y las migraciones.
...
* *Visor de recuperación ante desastres*: Solo visualización de información.
