...
* *Administrador de conmutación por error para la recuperación ante desastres*: Realiza conmutaciones por error y migraciones.
* *Administrador de aplicaciones de recuperación ante desastres*: crear y modificar planes de replicación; iniciar pruebas de conmutación por error.
...
|===
| Acción | Administración de recuperación ante desastres | Administrador de conmutación por error de recuperación ante desastres | Administrador de aplicaciones de recuperación ante desastres | Visor de recuperación ante desastres 


5+| *Activación y descubrimiento* 
...
| Crear, actualizar o eliminar credenciales  a| 
Sí
 a| 
Sí
 a| 
...
| Agregar, modificar o eliminar sitios o clústeres  a| 
Sí
 a| 
No
 a| 
...
| Crear o modificar transformaciones de recursos  a| 
Sí
 a| 
Sí
 a| 
