...
---
= Crear un agente de NetApp Console desde Azure Marketplace
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
Asegúrate de que la ubicación de red donde planeas instalar el agente de la NetApp Console cumple con los siguientes requisitos. Estos requisitos permiten que el agente de la NetApp Console gestione los recursos en tu nube híbrida.
...
.Resultado
Ya has instalado el agente de Console y lo has configurado con tu organización de Console.
