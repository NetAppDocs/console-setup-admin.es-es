...
---
= Instala manualmente el agente de NetApp Console en Azure
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
.Antes de empezar
* link:concept-agent-install-options.html#agent-cloud-manual-deploy["Aprende cuándo desplegar manualmente en Azure"].
