...
---
= Implementa un agente de NetApp Console desde Google Cloud
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Para desplegar un agente de Console en Google Cloud mediante Google Cloud, necesitas configurar tu red, preparar los permisos de Google Cloud, habilitar las API de Google Cloud y luego desplegar el agente de Console.
...
.Antes de empezar
* Deberías tener un link:concept-agents.html["Obtenga más información sobre los agentes de consola"].
