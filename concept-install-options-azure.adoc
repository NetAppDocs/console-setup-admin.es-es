...
* link:task-install-connector-azure-bluexp.html["Cree un agente de consola directamente desde la consola de NetApp"](esta es la opción estándar)
+
...
* link:task-install-connector-azure-marketplace.html["Crear un agente de consola desde Azure Marketplace"]
+
