...
* link:task-install-connector-aws-bluexp.html["Cree el agente de la consola directamente desde la consola"](esta es la opción estándar)
+
Esta acción inicia una instancia EC2 que ejecuta Linux y el software del agente de consola en una VPC de su elección.

* link:task-install-connector-aws-marketplace.html["Cree un agente de consola desde AWS Marketplace"]
+
