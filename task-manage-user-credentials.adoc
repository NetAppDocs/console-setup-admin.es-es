...
Por defecto, no se pide a los usuarios que introduzcan sus credenciales de ONTAP para acceder a ONTAP System Manager. Sin embargo, un administrador de la Console (con el rol Organization admin) puede configurar la Console para que pida a los usuarios que introduzcan sus credenciales de ONTAP. Cuando esta opción está activada, los usuarios tienen que introducir sus credenciales de ONTAP cada vez.
