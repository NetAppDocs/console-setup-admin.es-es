...
---
= Implementa manualmente el agente de NetApp Console en Google Cloud
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Para implementar manualmente el agente de la Console en tu propio host Linux, necesitas revisar los requisitos del host, configurar tu red, preparar los permisos de Google Cloud, habilitar las API de Google Cloud, instalar la Console y luego proporcionar los permisos que preparaste.
...
.Antes de empezar
* link:concept-agent-install-options.html#agent-cloud-manual-deploy["Aprende cuándo desplegar manualmente en Google Cloud"].
