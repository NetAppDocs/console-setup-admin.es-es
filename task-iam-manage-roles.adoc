...
TIP: A un miembro al que se le asigna el rol de administrador de la organización no se le pueden asignar roles adicionales. Ya tienen permisos en toda la organización. A un miembro con el rol de administrador de carpeta o proyecto no se le puede asignar ningún otro rol dentro de la carpeta o el proyecto donde ya tiene ese rol. Ambos roles proporcionan acceso a todos los servicios dentro del alcance que están asignados.
...
.. Para desasignar el rol de un miembro, seleccione image:icon-delete.png["Un icono que se parece a un bote de basura"] junto al rol para eliminar el rol respectivo del miembro.. Se le pedirá que confirme la eliminación.
