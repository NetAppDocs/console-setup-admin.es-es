...
Por ejemplo, si usas Microsoft Entra ID, puedes seguir los pasos indicados en la documentación de Microsoft link:https://learn.microsoft.com/en-us/entra/fundamentals/add-custom-domain["Agrega un dominio con Microsoft Entra ID"].
