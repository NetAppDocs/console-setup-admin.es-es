...
.Antes de empezar
Debe crear un agente de consola antes de poder cambiar la configuración de la consola. link:concept-connectors.html#connector-installation["Aprenda a crear un agente de consola"] .
