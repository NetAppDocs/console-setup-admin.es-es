...
* *Administrador de copias de seguridad y recuperación*: Realiza copias de seguridad en instantáneas locales, replica en almacenamiento secundario y haz copias de seguridad en almacenamiento de objetos en NetApp Backup and Recovery.
* *Backup and Recovery restore admin*: Restaura cargas de trabajo usando NetApp Backup and Recovery.
* *Backup and Recovery clone admin*: Clona aplicaciones y datos usando NetApp Backup and Recovery.
