...
Puedes configurar una conexión federada con Microsoft Entra ID para habilitar el inicio de sesión único (SSO) para la Console. El proceso implica configurar tu Microsoft Entra ID para que confíe en la Console como proveedor de servicios y luego crear la conexión en la Console.
...
+
*** Para la *Redirección URL*, usa `https://services.cloud.netapp.com`
...
. Crea la conexión con Microsoft Entra ID.
+
.. Introduce el ID de cliente y el secreto de cliente que creaste en el paso anterior.
