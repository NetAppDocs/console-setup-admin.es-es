...
| link:reference-iam-gcnv-roles.html["Usuario de Google Cloud NetApp Volumes"] | Los usuarios con el rol de usuario de Google Cloud NetApp Volumes pueden ver Google Cloud NetApp Volumes. 
