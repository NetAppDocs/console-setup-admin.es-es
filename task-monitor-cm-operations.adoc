...
También puedes verificar quién agregó un miembro a una organización o que un proyecto se eliminó correctamente.
...
[NOTE]
====
* La consola envía notificaciones por correo electrónico para el agente, las licencias y las suscripciones, NetApp Copy and Sync, NetApp Backup and Recovery y NetApp Ransomware Resilience.
...
.Pasos
. Selecciona *Administración > Configuración de notificaciones*.
