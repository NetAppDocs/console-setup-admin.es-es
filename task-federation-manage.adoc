...
[role="lead"]
Puedes gestionar tu federación en la NetApp Console. Puedes desactivarla, actualizar las credenciales caducadas o eliminarla si ya no la necesitas.
...
[NOTE]
====
* Si configuró la federación mediante NetApp Cloud Central, impórtela a través de la página *Federación* para administrarla en la consola.link:task-federation-import.html["Aprenda a importar su federación"]
* Puede ver eventos de administración de la federación, como habilitar, deshabilitar y actualizar federaciones en la página Auditoría. link:task-monitor-cm-operations.html["Obtenga más información sobre la supervisión de operaciones en la NetApp Console."]
...
. Seleccione *Administración > Identidad y acceso*.
. Seleccione la pestaña *Federación*.
. Selecciona el menú de acciones image:button_3_vert_dots.png["un icono con tres puntos verticales"] junto a la federación que quieres probar y selecciona *Probar conexión*.
...
. Seleccione *Administración > Identidad y acceso*.
. Seleccione la pestaña *Federación*.
. Selecciona el menú de acciones image:button_3_vert_dots.png["un icono con tres puntos verticales"] junto a la federación que quieres desactivar y selecciona *Desactivar*.
...
. Selecciona el menú de acciones image:button_3_vert_dots.png["un icono con tres puntos verticales"] junto a la federación que quieres eliminar y selecciona *Eliminar*.
