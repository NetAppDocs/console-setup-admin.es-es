...
image:diagram_permissions_multiple_azure.png["Una imagen conceptual que muestra la cuenta Azure inicial que recibe permisos a través de un rol personalizado y una identidad gestionada y dos cuentas adicionales que reciben permisos a través de un rol personalizado y un service principal."]
