...
NOTE: La página Recursos excluye los recursos de Amazon FSx for NetApp ONTAP porque los usuarios no pueden asociarlos con un rol.  Visualícelos en la página *Sistemas* o desde Cargas de trabajo.
