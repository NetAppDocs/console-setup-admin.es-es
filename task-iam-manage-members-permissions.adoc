...
Puede agregar un grupo federado de su proveedor de identidad (IdP) a su organización. Los miembros del grupo federado heredan los roles que usted asigna al grupo en la Consola.

.Antes de empezar:
Asegúrese de lo siguiente antes de agregar un grupo federado: * Debe haber configurado ya la federación entre su IdP y la consola. link:concept-federation.html["Aprenda cómo configurar la federación."] *El grupo ya debe existir en tu IdP. * Debes saber el nombre exacto del grupo en tu IdP. * Los usuarios que pertenecen al grupo ya deben haberse registrado en la NetApp Console y se les debe asignar explícitamente un rol en la consola.
