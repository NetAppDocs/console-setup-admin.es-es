...
NOTE: Debes tener los roles _Super admin_, _Organization admin_ o _Folder or project admin_ para gestionar IAM en NetApp Console.
...
--
Carpetas:: Agrupa los proyectos relacionados en _carpetas_ para organizarlos por ubicación, sitio o unidad de negocio. No puedes asociar recursos directamente a las carpetas, pero asignar a un usuario un rol a nivel de carpeta le da acceso a todos los proyectos de esa carpeta.



NOTE: Los usuarios con el rol Org admin pueden añadir recursos a una carpeta para delegar la tarea de asociar el recurso con proyectos a un Folder o a los administradores de proyecto de la carpeta respectiva. link:task-iam-manage-folders-projects.html#associate-resource-folder["Obtenga información sobre cómo asociar un recurso con una carpeta"].
...
Cargas de trabajo de Backup and Recovery (Oracle y Microsoft SQL Server):: Algunas cargas de trabajo de copia de seguridad y recuperación también se consideran recursos. Asigna una carga de trabajo de copia de seguridad y recuperación a un proyecto para conceder acceso a los usuarios.
...
NetApp Console proporciona funciones granulares que se adhieren a los principios de "mínimo privilegio", lo que significa que las funciones de acceso están diseñadas para dar a los usuarios acceso solo a lo que necesitan.

Los usuarios pueden tener varios roles a medida que sus funciones se amplían.
