...
| *config.deployments.list* | No | Sí | No 
...
| *config.previews.list* | No | Sí | No 


| *config.resources.list* | No | Sí | No 


| *config.revisiones.get* | No | Sí | No 
...
| *compute.forwardingRules.create* | Cree reglas de reenvío para enrutar el tráfico hacia los servicios backend. | No | Sí | No 


| *compute.forwardingRules.delete* | Eliminar reglas de reenvío existentes. | No | Sí | No 


| *compute.forwardingRules.get* | Recupere detalles sobre las reglas de reenvío existentes. | No | Sí | No 


| *compute.forwardingRules.setLabels* | Establecer o actualizar etiquetas en las reglas de reenvío para la organización. | No | Sí | No 


| computar.globalOperations.get | Para obtener el estado de las operaciones. | Sí | Sí | No 


| *compute.healthChecks.crear* .4+| Cree y administre controles de estado para supervisar el estado del servicio backend. | No | Sí | No 


| *compute.healthChecks.delete* | No | Sí | No 


| *compute.healthChecks.get* | No | Sí | No 


| *compute.healthChecks.useReadOnly* | No | Sí | No 
...
| *compute.instancias.uso* | Utilice instancias de máquinas virtuales (operaciones de inicio, detención y conexión). | No | Sí | No 
...
| *compute.resourcePolicies.create* .3+| Cree y administre políticas de recursos para la gestión automatizada de recursos. | No | Sí | No 


| *compute.resourcePolicies.delete* | No | Sí | No 


| *compute.resourcePolicies.get* | No | Sí | No 
...
| *logging.logEntries.create* .2+| Cree y enrute archivos de registro para monitoreo, depuración y auditoría. | Sí | Sí | No 


| *logging.logEntries.route* | Sí | Sí | No 
...
| *compute.addresses.createInternal* | Cree direcciones IP internas dentro de la red VPC para la asignación de recursos. | No | Sí | No 


| *compute.addresses.deleteInternal* | Eliminar direcciones IP internas para limpiar recursos. | No | Sí | No 


| *compute.addresses.setLabels* | Actualizar etiquetas en el recurso Dirección. | No | Sí | No 


| *compute.addresses.useInternal* | Utilice direcciones IP internas para la comunicación de red. | No | Sí | No 
...
| *compute.regionBackendServices.delete* | No | Sí | No 


| compute.regionBackendServices.get | Sí | No | No 


| *compute.regionBackendServices.update* | Sí | Sí | No 


| compute.regionBackendServices.list | Sí | No | No 


| *compute.regionBackendServices.use* | No | Sí | No 
...
| *compute.instanceGroups.create* | No | Sí | No 


| *compute.instanceGroups.delete* | No | Sí | No 


| *compute.instanceGroups.update* | No | Sí | No 


| *compute.instanceGroups.use* | No | Sí | No 
