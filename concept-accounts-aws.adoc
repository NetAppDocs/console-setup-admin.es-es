...
image:diagram_permissions_initial_aws.png["Una imagen conceptual que muestra la consola implementando el agente de consola en una cuenta de AWS. Una política de IAM se asigna a un rol de IAM, que está asociado a la consola."]
