...
---
= Implementa un agente de consola desde AWS Marketplace
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Puedes implementar un agente de Console en AWS directamente desde AWS Marketplace. Para implementar un agente de Console desde AWS Marketplace, necesitas configurar tu red, preparar los permisos de AWS, revisar los requisitos de la instancia y luego implementar el agente de Console.
...
.Antes de empezar
* link:concept-agent-install-options.html#agent-marketplace-deploy["Aprende cuándo implementar desde AWS Marketplace"].
...
Abra un navegador web y vaya a https://console.netapp.com["NetApp Console"^] para comenzar a utilizar el agente de la consola con la consola.
